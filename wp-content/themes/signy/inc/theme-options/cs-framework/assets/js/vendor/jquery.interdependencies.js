...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Signy the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is signyd.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to signy condition, true show always, false hide always
         *
         */
